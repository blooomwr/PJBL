...
<head>
    ...
    <style>
        ...
        .btn-signup:hover { background-color: #8a3c02 !important; }
        .divider-text { 
            display: flex; 
            align-items: center; 
            text-align: center; 
        ...
        .social-icons img { width: 50px; height: 50px; margin: 0 10px; cursor: pointer; }
        .logo-top { width: 70px; margin-bottom: 30px; }
...
<body>
    ...
    <div class="signup-container">
        ...
        <div class="social-icons">
            ...
            <img src="path/to/x-icon.png" alt="X">
        </div>
